...
<!--[if IE 9]><html class="ie9" lang="pt-br"><!--><html lang="pt-br"><!--<![endif]-->
    <head>
        ...
        <title>Café do Ponto - Exportação</title>
    ...
    <body id="pagCafes" class="interna">
        ...
        <div id="page">			
            <div class="conteudo">
                <div class="teaserInternas teaserExportacao">
                    <span class="faixaTopBanner"></span>
                    <h1>EXPORTAÇÃO</h1>
                    <span class="faixaBottomBanner"></span>
                </div>

                <section id="produto" class="produtoExportacao">
                    <div class="container">
                        <div class="col-lg-12">
                            <div class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                                ...
                                <span class="space">-</span>
                                <span typeof="v:Breadcrumb">
                                    <span rel="v:url" property="v:title">Exportação</span>
                                </span>
                            </div>
                        </div>
                        <div class="colTexto col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="textoProd">
                                ...
                                <div class="texto2">
                                    <p>
                                        ATRIBUTOS:<br>
                                        <strong>REDONDO E MARCANTE</strong>
                                    </p>
                                    <p>
                                        INTENSIDADE:<br>
                        ...
                        <div class="colImg col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="imgProd">
                                <img class="img-responsive" alt="Café do Ponto Exportação" src="images/exportacao-slider-home.png">
                                <div class="linkCafes">
                                    <ul>
