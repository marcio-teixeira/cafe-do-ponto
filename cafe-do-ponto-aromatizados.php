...
<!--[if IE 9]><html class="ie9" lang="pt-br"><!--><html lang="pt-br"><!--<![endif]-->
    <head>
        ...
        <title>Café do Ponto - Aromatizados</title>
    ...
    <body id="pagCafes" class="interna">
        ...
        <div id="page">			
            <div class="conteudo">
                <div class="teaserInternas teaserAromatizados">
                    <span class="faixaTopBanner"></span>
                    <h1>AROMATIZADOS</h1>
                    <span class="faixaBottomBanner"></span>
                </div>

                <section id="produto" class="produtoAromatizados">
                    <div class="container">
                        <div class="col-lg-12">
                            <div class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                                ...
                                <span class="space">-</span>
                                <span typeof="v:Breadcrumb">
                                    <span rel="v:url" property="v:title">Aromatizados</span>
                                </span>
                            </div>
                        </div>
                        <div class="colTexto col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="textoProd">
                                ...
                                <div class="texto2">
                                    <p>
                                        ATRIBUTOS:<br>
                                        <strong>INTENSOS E SABOROSOS</strong>
                                    </p>
                                    <p>
                                        INTENSIDADE:<br>
                        ...
                        <div class="colImg col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="imgProd">
                                <img class="img-responsive" alt="Café do Ponto Aromatizados" src="images/aromatizados-slider-home.png">
                                <div class="linkCafes">
                                    <ul>
