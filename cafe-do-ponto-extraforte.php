...
<!--[if IE 9]><html class="ie9" lang="pt-br"><!--><html lang="pt-br"><!--<![endif]-->
    <head>
        ...
        <title>Café do Ponto - Extraforte</title>
    ...
    <body id="pagCafes" class="interna">
        ...
        <div id="page">			
            <div class="conteudo">
                <div class="teaserInternas teaserExtraforte">
                    <span class="faixaTopBanner"></span>
                    <h1>EXTRAFORTE</h1>
                    <span class="faixaBottomBanner"></span>
                </div>

                <section id="produto" class="produtoExtraforte">
                    <div class="container">
                        <div class="col-lg-12">
                            <div class="breadcrumb" xmlns:v="http://rdf.data-vocabulary.org/#">
                                ...
                                <span class="space">-</span>
                                <span typeof="v:Breadcrumb">
                                    <span rel="v:url" property="v:title">Extraforte</span>
                                </span>
                            </div>
                        </div>
                        <div class="colTexto col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="textoProd">
                                <div class="texto1">
                                    ...
                                    <p>
                                        É um delicioso café encorpado com ponto de torra que revela um aroma intenso e envolvente.
                                    </p>
                                </div>
                                ...
                                <div class="texto2">
                                    <p>
                                        ATRIBUTOS:<br>
                                        <strong>FORTE E ENCORPADO</strong>
                                    </p>
                                    <p>
                                        INTENSIDADE:<br>
                                        <img alt="Intensidade 10" src="images/intensidade-10-branco.png">
                                    </p>
                                </div>
                            </div>
                        </div>
                        <div class="colImg col-lg-6 col-md-6 col-sm-6 col-xs-6">
                            <div class="imgProd">
                                <img class="img-responsive" alt="Café do Ponto Extraforte" src="images/extra-forte-slider-home.png">
                                <div class="linkCafes">
                                    <ul>
